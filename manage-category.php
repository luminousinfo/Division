...
<div xmlns="http://www.w3.org/1999/xhtml" class="wrap nosubsub">
			...
			<div>
				<div class="form-wrap">
					...
					<form class="validate" action="admin.php?page=<?php echo $tableName; ?>" method="post" id="addtag">
						...
						<!-- </div> -->
						<div class="form-field">
							<label for="tag-name">Category Name </label>
	...
	<?php
		...
		?>
				<tr>
					<td><?php echo ++$key; ?></td>
					<!-- <td nowrap><?php //echo $objPub->getName($wpdb->prefix."master_section",$val->master_section_id); ?></td> -->
					...
					<td><u><a href="admin.php?page=<?php echo $tableName ?>&info=del&did=<?php echo $id;?>" class="button" style="background: #DC143C; border-color:#DC143C; color: #ffffff;" onclick="return confirm('Are you sure want to Delete!')">Delete</a></u></td>
				</tr>
	<?php }
		} else { ?>
				<tr>
