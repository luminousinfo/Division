				...
				<div class="form-wrap">
					...
					<form class="validate" action="admin.php?page=<?php echo $tableName; ?>" method="post" id="addtag">
						<div class="form-field">
							<label for="tag-name">District Name </label>
	...
	<?php
		...
		?>
				<tr>
					...
					<td><a href="admin.php?page=<?php echo $tableName ?>&info=del&did=<?php echo $id;?>" class="button" onclick="return confirm('Are you sure want to delete?')" style="background: #DC143C; border-color:#DC143C; color: #ffffff;" onclick="return confirm('Are sure want to Delete!')">Delete</a></td>
				</tr>
	<?php }
		} else { ?>
				<tr>
